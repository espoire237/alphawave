...
const ICONS = {
  africa: (
    <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="M8 14C8 14 9 17 12 17C15 17 16 14 16 14"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
  ...
  network: (
    <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
      ...
      <path
        d="M6 7L10 11M14 13L18 17M18 7L14 11M10 13L6 17"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
  ...
  ai: (
    <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="M7 10H9M11 10H13M15 10H17M7 14H11M13 14H17"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
  ...
  trophy: (
    <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
      <path
        d="M8 21H16M12 17V21M7 3H17V10C17 13.31 14.76 16 12 16C9.24 16 7 13.31 7 10V3Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
      <path
        d="M7 5H3V9C3 11.21 4.79 13 7 13"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
      <path
        d="M17 5H21V9C21 11.21 19.21 13 17 13"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          ...
          >
            ...
            >
              {t("servicesPage.whyChooseUs.eyebrow")}
            </span>
            <span
              style={{
                width: 28,
          ...
          >
            {t("servicesPage.whyChooseUs.titleAccent")}
            <span
              style={{
                color: MY_COLORS.orange,
        ...
        >
          {DIFFERENTIATORS.map((item, i) => {
            const item_t = t(`servicesPage.data.differentiators.${item.id}`, {
              returnObjects: true,
            });
