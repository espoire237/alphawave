    ...
    >
      <div
        style={{
          ...
          height: 400,
          borderRadius: "50%",
          background: `radial-gradient(ellipse, rgba(232,117,10,0.08) 0%, transparent 65%)`,
          pointerEvents: "none",
        }}
      />
      <div
      ...
      >
        <div
          ...
          style={{
            ...
            padding: "72px 80px",
            borderRadius: 24,
            background: `linear-gradient(135deg, rgba(232,117,10,0.1) 0%, rgba(232,117,10,0.05) 40%, rgba(10,10,10,0.9) 100%)`,
          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                ...pos,
                borderTop:
                  i < 2 ? `1.5px solid ${MY_COLORS.orangeBorder}` : "none",
                borderBottom:
                  i >= 2 ? `1.5px solid ${MY_COLORS.orangeBorder}` : "none",
                borderLeft:
                  i % 2 === 0
                    ? `1.5px solid ${MY_COLORS.orangeBorder}`
                    : "none",
                borderRight:
                  i % 2 !== 0
                    ? `1.5px solid ${MY_COLORS.orangeBorder}`
            ...
            <Link
              ...
              style={{
                ...
                boxShadow: primaryHover
                  ? `0 0 40px rgba(232,117,10,0.55)`
                  : `0 0 24px rgba(232,117,10,0.35)`,
