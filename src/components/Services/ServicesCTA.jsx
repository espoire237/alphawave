  ...
  return (
    <section ref={sectionRef} style={{ position: "relative", background: MY_COLORS.bgBase, padding: "80px 0 100px", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 40px", position: "relative" }}>
        <div data-reveal style={{ position: "relative", padding: "72px 80px", borderRadius: 24, background: `linear-gradient(135deg, rgba(232,117,10,0.1) 0%, rgba(232,117,10,0.05) 40%, rgba(10,10,10,0.9) 100%)`, border: `1px solid ${MY_COLORS.orangeBorder}`, overflow: "hidden", textAlign: "center", opacity: 0, transform: "translateY(30px) scale(0.98)", transition: "opacity 0.7s ease, transform 0.7s ease" }}>
          ...
          {/* Eyebrow */}
          <div data-reveal style={{ display: "inline-flex", alignItems: "center", gap: 10, marginBottom: 20, opacity: 0, transform: "translateY(16px)", transition: "all 0.6s ease" }}>
            <span style={{ width: 24, height: 2, borderRadius: 9999, background: MY_COLORS.gradientOrange }} />
            <span style={{ fontFamily: FONTS.primary, fontSize: FONTS.size.xs, fontWeight: FONTS.weight.bold, letterSpacing: FONTS.tracking.widest, textTransform: "uppercase", color: MY_COLORS.orange }}>Ready To Start?</span>
            <span style={{ width: 24, height: 2, borderRadius: 9999, background: MY_COLORS.gradientOrange }} />
          </div>

          <h2 data-reveal style={{ fontFamily: FONTS.primary, fontSize: "clamp(28px, 4vw, 52px)", fontWeight: FONTS.weight.extrabold, letterSpacing: FONTS.tracking.tight, lineHeight: FONTS.leading.snug, color: MY_COLORS.textPrimary, margin: "0 auto 16px", maxWidth: 640, opacity: 0, transform: "translateY(20px)", transition: "all 0.6s ease" }}>
            Ready to Transform Your{" "}
            <span style={{ color: MY_COLORS.orange, textShadow: `0 0 30px ${MY_COLORS.orangeGlow}` }}>Business?</span>
          </h2>

          <p data-reveal style={{ fontFamily: FONTS.secondary, fontSize: FONTS.size.md, lineHeight: FONTS.leading.relaxed, color: MY_COLORS.textSecondary, margin: "0 auto 40px", maxWidth: 560, opacity: 0, transform: "translateY(20px)", transition: "all 0.6s ease" }}>
            From Cameroonian startups to pan-African enterprises — AlphaWaves is your strategic technology partner for digital transformation that drives measurable competitive advantage.
          </p>

          <div data-reveal style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 16, flexWrap: "wrap", opacity: 0, transform: "translateY(20px)", transition: "all 0.6s ease" }}>
