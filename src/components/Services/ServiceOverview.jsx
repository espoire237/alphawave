...
const ICONS = {
  ...
  brain: (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
      <path
        d="M12 4C10.3 4 9 5.3 9 7C9 5.3 7.7 4 6 4C4.3 4 3 5.3 3 7C3 9 4 10.5 6 11.5V20H18V11.5C20 10.5 21 9 21 7C21 5.3 19.7 4 18 4C16.3 4 15 5.3 15 7C15 5.3 13.7 4 12 4Z"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinejoin="round"
      />
  ...
  cloud: (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
      <path
        d="M6.5 19C4 19 2 17 2 14.5C2 12.3 3.6 10.5 5.7 10.1C5.3 9.4 5 8.7 5 8C5 5.8 6.8 4 9 4C10.5 4 11.8 4.8 12.6 6C13.1 5.7 13.8 5.5 14.5 5.5C16.4 5.5 18 7.1 18 9C18 9.3 18 9.6 17.9 9.9C19.7 10.4 21 12 21 14C21 16.2 19.2 18 17 18L6.5 19Z"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinejoin="round"
      />
...
const ServiceCard = ({ service, index, isMobile,t }) => {
    

  const [hovered, setHovered] = useState(false);
  const svc = t(`servicesPage.data.services.${service.slug}`, { returnObjects: true });
    ...
    <div
     ...
     >
      ...
      {service.is_featured && (
        ...
        >
          {t("servicesPage.overview.popular")}
        </div>
      )}
      ...
      >
       {t("servicesPage.overview.getStarted")}  <ArrowRight />
      </Link>
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: isMobile ? 36 : 64 }}>
          ...
          >
           {t("servicesPage.overview.title")}{" "}
            ...
            >
             {t("servicesPage.overview.titleAccent")}
            </span>
          </h2>
        ...
        <div
         ...
         >
          {SERVICES.filter((s) => s.status === "published").map(
            (service, i) => (
              <ServiceCard
                key={service.id}
                service={service}
