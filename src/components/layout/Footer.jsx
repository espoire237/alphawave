          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
            ...
            <div className="col-span-1">
              ...
              <div className="flex space-x-4 mt-4">
                ...
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2s9 5 20 5a9.5 9.5 0 00-9-5.5c4.75 2.25 7-7 7-7s1.5 5.5-5.5 8.5" />
                  </svg>
                </a>
                <a
