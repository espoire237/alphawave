...
const FooterLink = ({ to, children, style = {} }) => {
  ...
  return (
    <Link
      ...
      style={{
        ...
        textDecoration: "none",
        color: hov ? MY_COLORS.textPrimary : MY_COLORS.textSecondary,
...
const Footer = () => {
  ...
  // ✅ footerLinks lives INSIDE the component so t() is in scope
  const footerLinks = [
    {
      title: t("footer.sections.services"),
      links: [
        { label: t("footer.links.customSoftware"),   path: "/services/custom-software-development" },
        { label: t("footer.links.aiAnalytics"),      path: "/services/ai-business-intelligence"    },
        { label: t("footer.links.digitalMarketing"), path: "/services/digital-marketing-seo"       },
        { label: t("footer.links.cloudDevops"),      path: "/services/cloud-infrastructure-devops" },
        { label: t("footer.links.mobileApps"),       path: "/services/mobile-first-solutions"      },
        { label: t("footer.links.paymentSystems"),   path: "/services/payment-infrastructure"      },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        { label: t("footer.links.privacyPolicy"), path: "/privacy-policy" },
  ...
  const outerPadding = isMobile ? "48px 20px 0" : isTablet ? "56px 32px 0" : "64px 44px 0";
  const gridColumns  = isMobile ? "1fr" : isTablet ? "1fr 1fr" : "2fr 1fr 1fr 1fr";

  return (
    <footer
      style={{
        background: `
          radial-gradient(ellipse 80% 300px at 50% 0%, rgba(232,117,10,0.25) 0%, transparent 80%),
          linear-gradient(180deg, #0f0f0f 0%, ${MY_COLORS.bgGlassScrolled} 100%)
        `,
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto", padding: outerPadding }}>
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              {socialLinks.map((s) => (
                <a
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background  = MY_COLORS.bgSurface;
        ...
        >
          ...
          <div style={{ display: "flex", gap: isMobile ? 16 : 24, flexWrap: "wrap" }}>
            {[
              { label: t("footer.bottom.privacy"), path: "/privacy-policy" },
              { label: t("footer.bottom.terms"),   path: "/terms"          },
              { label: t("footer.bottom.sitemap"), path: "#"               },
            ].map((link) => (
              <FooterLink
                key={link.label}
                to={link.path}
