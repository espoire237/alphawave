    ...
    return (
      <div>
        ...
        <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 12 }}>
          {links.map((link) => (
            <li key={link.label}>
              <FooterLink to={link.path} style={{ fontFamily: FONTS.secondary, fontSize: FONTS.size.sm, fontWeight: FONTS.weight.regular }}>
                {link.label}
              </FooterLink>
            </li>
          ))}
  ...
  return (
    <div style={{ borderBottom: `1px solid ${MY_COLORS.border}` }}>
      ...
      >
        ...
        >
          <path d="M3 6L8 11L13 6" stroke={MY_COLORS.textMuted} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </button>
      ...
      <div style={{
        ...
        <ul style={{ listStyle: "none", padding: "0 0 16px 0", margin: 0, display: "flex", flexDirection: "column", gap: 14 }}>
          {links.map((link) => (
            <li key={link.label}>
              <Link
                to={link.path}
              ...
              >
                <span style={{ width: 4, height: 4, borderRadius: "50%", background: MY_COLORS.orange, flexShrink: 0 }} />
                {link.label}
              </Link>
            </li>
          ))}
...
const Footer = () => {
  ...
  return (
    <footer style={{
      // ✅ FIX 1 — gradient background, no scrolled state needed in footer
      background: `
          ...
          <div style={{ display: "flex", gap: isMobile ? 16 : 24, flexWrap: "wrap" }}>
            {[
              ...
              <FooterLink
                key={link.label}
                to={link.path}
                style={{ fontFamily: FONTS.secondary, fontSize: FONTS.size.xs, color: MY_COLORS.textMuted }}
              >
                {link.label}
              </FooterLink>
            ))}
