...
const Navbar = () => {
  ...
  // FIX #1 — Close drawer on route change (was setState during render)
...
useEffect(() => {
  const handleResize = () => {
    if (window.innerWidth >= 1024 && menuOpenRef.current) {
      setMenuOpen(false);
    }
  };
  ...
  return (
    <>
      ...
      >
        ...
        <div
          style={{ maxWidth: 1280, margin: "0 auto", padding: headerPadding }}
        >
          <div
            style={{
              display: "flex",
          ...
          >
            ...
            >
              ...
              <span
                style={{
                  ...
                  fontWeight: FONTS.weight.bold, // FIX #8
                  letterSpacing: "-0.5px",
                  color: "#ffffff",
                  fontFamily: FONTS.primary, // FIX #4
                }}
              >
                Alpha
                <span
            ...
            {!isMobile && !isTablet && (
              ...
              >
                {/* FIX #3 — only render indicator when ready AND has valid width */}
                {indicator.ready && indicator.width > 0 && (
                  <span
                    style={{
                      ...
                      boxShadow:
                        "0 0 10px rgba(232,117,10,1), 0 0 24px rgba(232,117,10,0.4)",
                      transition:
                ...
                {NAV_ITEMS.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      aria-current={isActive ? "page" : undefined} // FIX #6
                      ...
                      style={{
                        ...
                        padding: "10px 14px",
                        borderRadius: 8,
                        fontSize: FONTS.size.sm, // FIX #4
                        fontWeight: isActive
                          ? FONTS.weight.bold // FIX #8
              ...
              {!isMobile && !isTablet && (
                <Link
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    fontSize: FONTS.size.sm, // FIX #4
                    fontWeight: FONTS.weight.semibold, // FIX #8
                    color: "#ffffff",
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow =
                      "0 0 28px rgba(232,117,10,0.65)";
                    e.currentTarget.style.transform = "translateY(-1px)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.boxShadow =
                      "0 0 18px rgba(232,117,10,0.35)";
      ...
      <div
        style={{
          ...
          overflowY: "auto",
          WebkitOverflowScrolling: "touch", // FIX #7 — smooth scroll on iOS
        }}
      >
        {/* Drawer Header */}
        <div
        ...
        <div style={{ padding: "20px 20px 4px" }}>
          <Link
            ...
            style={{
              ...
              padding: "13px 20px",
              borderRadius: 10,
              fontSize: FONTS.size.base, // FIX #4
              fontWeight: FONTS.weight.semibold, // FIX #8
              color: "#ffffff",
              background: `linear-gradient(135deg, ${MY_COLORS.orange}, ${MY_COLORS.orangeLight})`,
              ...
              >
                ...
                <svg
                  ...
                  style={{
                    ...
                    transform:
                      isActive || isHov ? "translateX(0)" : "translateX(-4px)",
