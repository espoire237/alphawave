...
const ICONS = {
  cart: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path
        d="M6 2L3 6V20C3 21.1 3.9 22 5 22H19C20.1 22 21 21.1 21 20V6L18 2H6ZM16 10C16 11.66 14.21 13 12 13C9.79 13 8 11.66 8 10"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
  ...
  leaf: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path
        d="M12 22C12 22 4 16 4 9C4 5.13 7.13 2 11 2C15 2 20 5 20 10C20 15 12 22 12 22Z"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinejoin="round"
      />
      <path
        d="M12 22V12M12 12C12 12 8 9 8 6"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
      />
  ...
  hotel: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path
        d="M3 22V4C3 2.9 3.9 2 5 2H19C20.1 2 21 2.9 21 4V22"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
      />
      <path
        d="M3 22H21M9 22V17H15V22M9 7H10M14 7H15M9 11H10M14 11H15"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
      />
  ...
  briefcase: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="M16 7V5C16 3.9 15.1 3 14 3H10C8.9 3 8 3.9 8 5V7M12 12V12.01M2 13H22"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
      />
    ...
    >
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(ellipse, rgba(232,117,10,0.06) 0%, transparent 65%)",
          pointerEvents: "none",
        }}
      />
      <div
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", position: "relative" }}>
        <div style={{ textAlign: "center", marginBottom: isMobile ? 32 : 56 }}>
          ...
          >
            ...
            >
              {t("industriesServed.sectorLabel")}
            </span>
            <span
              style={{
                width: 28,
          ...
          >
            {t("industriesServed.heading")}
            <span style={{ color: MY_COLORS.orange }}>
              {t("industriesServed.headingHighlight")}
            </span>
          </h2>
        </div>
        <div
        ...
        >
          {INDUSTRIES.map((industry) => (
            ...
            >
              ...
              >
                 {t(`industriesServed.industries.${industry.id}.name`)}
              </h3>
              <div
                style={{
                  fontFamily: FONTS.primary,
              ...
              >
                {t("industriesServed.projectsCount", { count: industry.projects })}
              </div>
              <div
                style={{
                  fontFamily: FONTS.secondary,
                  fontSize: isMobile ? 11 : FONTS.size.xs,
                  color: MY_COLORS.textMuted,
                  lineHeight: "1.4",
                }}
              >
                {t(`industriesServed.industries.${industry.id}.metric`)}
              </div>
            </div>
          ))}
        </div>
