...
const QuoteIcon = () => (
  <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
    <path
      d="M8 26c0-6.8 4.3-11.8 10-13.6l1.8 3C16 17.2 14.2 20 13.6 23.5H18V33H8V26zm14 0c0-6.8 4.3-11.8 10-13.6l1.8 3C30 17.2 28.2 20 27.6 23.5H32V33H22V26z"
      fill={MY_COLORS.orange}
      opacity="0.25"
    />
  </svg>
);
...
const GlobeIcon = () => (
  <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
    ...
    <path
      d="M8 2c-2 2-3 3.6-3 6s1 4 3 6M8 2c2 2 3 3.6 3 6s-1 4-3 6M2 8h12"
      stroke="currentColor"
      strokeWidth="1.2"
      strokeLinecap="round"
    />
...
const TECH_COLORS = {
  ...
  Stripe: "#635BFF",
  "AI/ML": "#E8750A",
  "SMS Integration": "#34B7F1",
  "Video Streaming": "#FF0000",
  "Booking Engine API": "#00B4D8",
...
const buildDescription = (post, t) => {
  const catMap = {
    ...
    healthcare: t("postPage.industryLabels.healthcare"),
    finance: t("postPage.industryLabels.finance"),
    hospitality: t("postPage.industryLabels.hospitality"),
    education: t("postPage.industryLabels.education"),
  };

  const typeMap = {
    web: t("postPage.typeLabels.web"),
    mobile: t("postPage.typeLabels.mobile"),
    ai: t("postPage.typeLabels.ai"),
  };

  const cat = catMap[post.industry_category] || post.industry_category || "";
  const type = typeMap[post.project_type] || "digital solution";
  const client = post.client_confidential
...
const RelatedCard = ({ project, t }) => {
  const [hovered, setHovered] = useState(false);
  const catLabel =
    CATEGORIES.find((c) => c.id === project.industry_category)?.label ||
  ...
  return (
    <Link
      ...
      style={{
        ...
        boxShadow: hovered ? "0 20px 48px rgba(232,117,10,0.1)" : "none",
    ...
    >
      <div
        style={{
          height: 130,
          background:
            "linear-gradient(135deg, rgba(232,117,10,0.16) 0%, rgba(10,10,10,0.9) 100%)",
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        >
          {t("postPage.viewCaseStudy")} <ArrowRight />
        </div>
      </div>
    </Link>
  );
...
const PortfolioPostPage = () => {
  ...
  const related = post
    ? PROJECTS.filter((p) => p.slug !== slug)
        .sort(
          (a, b) =>
            (b.industry_category === post.industry_category ? 1 : 0) -
            (a.industry_category === post.industry_category ? 1 : 0),
        )
        .slice(0, 3)
    : [];

  const catLabel = post
    ? CATEGORIES.find((c) => c.id === post.industry_category)?.label ||
  ...
  if (!post)
    return (
      ...
      >
        ...
        >
          <ArrowLeft /> {t("postPage.backPortfolio")}
        </Link>
      </div>
    );
  ...
  return (
    <div style={{ background: MY_COLORS.bgBase, minHeight: "100vh" }}>
      ...
      >
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(232,117,10,0.06) 0%, transparent 65%)",
            pointerEvents: "none",
          }}
        />
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              "linear-gradient(rgba(232,117,10,0.015) 1px, transparent 1px), linear-gradient(90deg, rgba(232,117,10,0.015) 1px, transparent 1px)",
        ...
        <div style={{ maxWidth: maxW, margin: "0 auto", position: "relative" }}>
          ...
          <Reveal delay={0.1}>
            <h1
              style={{
                fontFamily: FONTS.primary,
                fontSize: isMobile ? 30 : isTablet ? 40 : 54,
                fontWeight: 900,
                color: MY_COLORS.textPrimary,
                margin: "0 0 20px",
                lineHeight: 1.1,
      ...
      <Reveal style={{ padding: `0 ${px}` }}>
        <div style={{ maxWidth: maxW, margin: "0 auto" }}>
          <div
            style={{
              width: "100%",
              aspectRatio: isMobile ? "16/8" : isTablet ? "16/7" : "21/8",
              borderRadius: isMobile ? 16 : 24,
              overflow: "hidden",
              background:
                "linear-gradient(135deg, rgba(232,117,10,0.28) 0%, rgba(15,12,10,0.97) 50%, rgba(10,10,10,1) 100%)",
              border: `1px solid ${MY_COLORS.orangeBorder}`,
              boxShadow:
                "0 40px 100px rgba(0,0,0,0.7), 0 0 0 1px rgba(232,117,10,0.06)",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              position: "relative",
          ...
          >
            ...
            <div
              style={{
                ...
                inset: 0,
                backgroundImage:
                  "repeating-linear-gradient(0deg, transparent, transparent 36px, rgba(232,117,10,0.025) 36px, rgba(232,117,10,0.025) 37px)",
                pointerEvents: "none",
              }}
            />
            <div
        ...
        <div style={{ maxWidth: maxW, margin: "0 auto" }}>
          <div
            style={{
              display: "grid",
              gridTemplateColumns:
                isMobile || isTablet ? "1fr 1fr" : "repeat(4, 1fr)",
              gap: isMobile ? 12 : 16,
            }}
          >
            {[
              {
                icon: <UserIcon />,
                label: t("postPage.client"),
                value: post.client_confidential
                  ? t("postPage.confidential")
                ...
                <Reveal key={i} delay={i * 0.1}>
                  <p
                    style={{
                      ...
                      lineHeight: 1.85,
                      color:
                        i === 0 ? MY_COLORS.textSecondary : MY_COLORS.textMuted,
                      margin: 0,
            ...
            <Reveal delay={0.15}>
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                >
                  ...
                  >
                    {t("postPage.highlights", { returnObjects: true }).map(
                      (point, i) => (
                        <div
                          key={i}
                          style={{
      ...
      <section
        style={{ padding: `${py} ${px}`, background: MY_COLORS.bgSection }}
      >
        <div style={{ maxWidth: maxW, margin: "0 auto" }}>
          <Reveal>
            <div
            ...
            <Reveal delay={0.05}>
              <div
                style={{
                  ...
                  background: MY_COLORS.bgSurface,
                  border: `1px solid ${MY_COLORS.orangeBorder}`,
                  borderLeft: `3px solid ${MY_COLORS.orange}`,
                  height: "100%",
                }}
              >
                <p
              ...
              >
                <div
                  style={{
                    width: 24,
                    height: 1,
                    background: MY_COLORS.orangeBorder,
                  }}
                />
                <span
                  style={{
        ...
        <div style={{ maxWidth: maxW, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
            {post.technologies.map((tech, i) => (
              <TechBadge key={i} tech={tech} index={i} isMobile={isMobile} />
            ))}
          </div>
        </div>
      </section>
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      "radial-gradient(circle, rgba(232,117,10,0.07) 0%, transparent 70%)",
                    pointerEvents: "none",
                  }}
                />
                <div
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                  ...
                  <div>
                    ...
                    >
                      {post.testimonial.title} · {post.testimonial.company}
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section
        style={{
          padding: isMobile ? `${py} 20px` : `88px 48px`,
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse 80% 80% at 50% 50%, rgba(232,117,10,0.07) 0%, transparent 65%)",
            pointerEvents: "none",
          }}
        />
        <Reveal
        ...
        >
          ...
          >
            {t("postPage.ctaTitle")} <br />
            <span style={{ color: MY_COLORS.orange }}>
              {t("postPage.ctaTitleAccent")}
            </span>
          </h2>
          ...
          >
            <Link
              ...
              style={{
                ...
                color: "#fff",
                textDecoration: "none",
                boxShadow: "0 8px 28px rgba(232,117,10,0.3)",
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  "0 14px 36px rgba(232,117,10,0.4)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow =
                  "0 8px 28px rgba(232,117,10,0.3)";
              }}
            >
              {t("postPage.startProject")} <ArrowRight />
            </Link>
